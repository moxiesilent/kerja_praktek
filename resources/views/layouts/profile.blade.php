  ...
  <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav on no-full">
    ...
    <div class="container">   
      ...
      <div class="navbar-header">
        ...
        <div class="logo"> <a href="{{url('/')}}"> <img class="logo logo-display" src="{{asset('assets/undana/navbar.png')}}" alt=""> <img class="logo logo-scrolled" src="{{asset('assets/undana/navbar.png')}}" alt=""> </a> </div>
      </div>
